...
pub fn build_multiplicative_expression_node<'a>(pair: Pair<'a, Rule>) -> Result<ExpressionNode<'a>, AstBuilderError> {
    ...
    while let Some(op_pair) = inner.next() {
        ...
        let op = match op_pair.as_str() {
            ...
            "/" => BinaryOp::Div,
            "%" => BinaryOp::Mod,
            _   => return Err(AstBuilderError(format!("Unknown multiplicative operator: {}", op_pair.as_str()))),
        };

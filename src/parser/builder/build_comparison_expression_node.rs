...
pub fn build_comparison_expression_node<'a>(pair: Pair<'a, Rule>) -> Result<ExpressionNode<'a>, AstBuilderError> {
    ...
    while let Some(op_pair) = inner.next() {
        ...
        let op = match op_pair.as_str() {
            ...
            ">=" => BinaryOp::Ge,
            "<=" => BinaryOp::Le,
            _    => return Err(AstBuilderError(format!("Unknown comparison operator: {}", op_pair.as_str()))),
        };
